...
<!DOCTYPE HTML PUBLIC "-//W3C//DTD HTML 4.01 	Transitional//EN" "http://www.w3.org/TR/html4/loose.dtd">
  <html>
    <head>
      <title> Consulta datos medidos dispositivo eHealth, por rango de fechas
		  </title>
    </head>
    <body>
      <table width="80%" align=center cellpadding=5 border=1 bgcolor="#FFFFFF">
    	 <tr>
         <td valign="top" align=center width=80& colspan=6 bgcolor="red">
           <img src="img/ehealth.png" width=800 height=250>
         </td>
 	     </tr>
 	     <tr>
         <td valign="top" align=center width=80& colspan=6 bgcolor="red">
           <h1> <font color=white>Consulta datos medidos dispositivo eHealth, por rango de fechas</font></h1>
         </td>
 	     </tr>
<?php
