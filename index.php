...
<html lang="en">
   <head>
      ...
      <!-- bootstrap css -->
      <link rel="stylesheet" href="/ehealth/static/css/bootstrap.min.css">
      <!-- style css -->
      <link rel="stylesheet" href="/ehealth/static/css/style.css">
      <!-- Responsive-->
      <link rel="stylesheet" href="/ehealth/static/css/responsive.css">
      <!-- Scrollbar Custom CSS -->
      <link rel="stylesheet" href="/ehealth/static/css/jquery.mCustomScrollbar.min.css">
      <!-- fevicon -->
               ...
               <div class="col-xl-3 col-lg-3 col-md-3 col-sm-3 col logo_section">
                  <div class="full">
                     <div class="center-desk">
                        <div class="logo"> <a class="inicio" href="#">eHealth</a> </div>
                     </div>
                  </div>
               </div>
                     ...
                     <div class="limit-box">
                        <nav class="main-menu">
                           <ul class="menu-area-main">
                              <li class="active"> <a class="sesion" href="interfaces\iniciar_sesion.php">Iniciar Sesión</a> </li>
